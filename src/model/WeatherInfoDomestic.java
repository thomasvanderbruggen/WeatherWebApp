...
public class WeatherInfoDomestic {
	...
	public WeatherInfoDomestic() { } 
	public WeatherInfoDomestic(String city, String state) { 
		this.city = city; 
		this.state = state; 
		setWeather(); 
	}
	...
	public void setWeather() { 
		...
		try {
			...
			URL url = new URL("http://api.openweathermap.org/data/2.5/weather?q=" + cityForURL + "," + state + ",US" +"&appid=" + API_KEY + "&units=imperial"); 
